...
public class tb_usuario extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText ed_nombre,ed_apellido,ed_correo,ed_usuario,ed_clave,ed_tipo,ed_estado,ed_pregunta,ed_respuesta;
    ...
    public void alta(View v){
        ...
        if(inputE1&& inputE2&& inputE3&&inputE4&&inputE5&&inputE6&&inputE7&&inputE8&&inputE9) {
            try {
             ...
             //   datos.setPrecio(Double.parseDouble(et_precio.getText().toString()));
                ...
                if (conexion.InsertTradicional(datos)) {
                    ...
                    Toast.makeText(this, "Error. Ya existe un registro\n" +
                            "Nombre: " + ed_nombre.getText().toString(), Toast.LENGTH_SHORT).show();
                    limpiarDatos();
                }
            } catch (Exception e) {
